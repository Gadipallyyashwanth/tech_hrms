...
SECRET_KEY = 'django-insecure-iqe4ezw&t1b79=-y-9%*ffgycuilyu$ml^b2&3m_d7va_y+=e0'
...
INSTALLED_APPS = [
    ...
    'hr',  #  Add this line for your HRMS app
    'rest_framework',
    'corsheaders',
...
CSRF_COOKIE_HTTPONLY = False  # Make it accessible from JS (React)
